...
'Identifies WorkSheet Locations within the curret Workbook/Project and passes the cell(s) calues into/within a string
'This uses the formate of {% Sheet1!A1:A3 %}
    ...
    'Retuens an Array single Strings
